			...
			<p class="alert-success" >
				...
				?>
					...
					<div class="box-content"style=" font-size: 18px; font-weight: bold">
						<form class="form-horizontal" action="<?php echo e(route('file.store')); ?>" method="post" enctype="multipart/form-data">
						  ...
						  <fieldset>
							...
							<div class="control-group">
                                ...
                                foreach($all_department as $v_department){?>
									<option value="<?php echo e($v_department->department_id); ?>"><?php echo e($v_department->department_name); ?></option>
									<?php } ?>
							  ...
							  <div class="control-group">
                                ...
                                foreach($all_course as $v_course){?>
									<option value="<?php echo e($v_course->course_id); ?>"><?php echo e($v_course->course_code); ?></option>
									<?php } ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SUST-Archive-master\resources\views/add_file.blade.php ENDPATH**/ ?>